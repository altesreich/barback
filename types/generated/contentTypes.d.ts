...
export interface ApiItemMenuItemMenu extends Struct.CollectionTypeSchema {
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    amount: Schema.Attribute.JSON;
    coment: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    item_menus: Schema.Attribute.Relation<
      'manyToMany',
      'api::item-menu.item-menu'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::order.order'> &
      Schema.Attribute.Private;
    order_status: Schema.Attribute.Enumeration<['pending', 'paid', 'sent']>;
    publishedAt: Schema.Attribute.DateTime;
    table: Schema.Attribute.Enumeration<
      [
        'Mesa 1',
        'Mesa 2',
        'Mesa 3',
...
export interface ApiReservationReservation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    status_reservation: Schema.Attribute.Enumeration<
